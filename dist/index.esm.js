...
var Button = function (_a) {
    var children = _a.children, onClick = _a.onClick, style = _a.style;
    return (jsxRuntimeExports.jsx("button", __assign({ className: "custom-button", style: style, onClick: onClick }, { children: children })));
};
